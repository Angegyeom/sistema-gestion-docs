        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href={presentation.presentUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <span>📱</span>
                Modo Presentación
              </a>
            </div>
